...
def contact(request):
    if request.method == "POST":
        ...
        contact = Contact(listing=listing_title, listing_id=listing_id, email=email, phone=phone, 
                message=message, user_id=user_id)
        contact.save()
        send_mail(
            "Listing Inquiry",
            "Inquiry for " + listing_title + ', Sign into admin for more info', 'admin@bcre.com',
